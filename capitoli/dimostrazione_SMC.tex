...
L'introduzione dello strato limite comporta la perdita della stabilità asintotica
dell'origine. In presenza della regolarizzazione della legge di controllo, il
sistema non converge esattamente a $s=0$; tuttavia, le traiettorie raggiungono
in \textit{tempo finito} un intorno della superficie di sliding (boundary layer)
e rimangono uniformemente limitate al suo interno. Per questo motivo si parla
di \textbf{stabilità pratica}. In particolare, come riportato in
\cite{khalil2002nonlinear}, il sistema risulta \textit{ultimately bounded}, con
un \textit{ultimate bound} la cui ampiezza dipende dal parametro $\Phi$ e dai
guadagni del controllore. Riducendo opportunamente il valore di $\Phi$, tale
bound può essere reso arbitrariamente piccolo.
