...
\begin{itemize}
    \item \textbf{Multirotori:} Questa classe, che include quadricotteri ed esacotteri, è caratterizzata da una notevole semplicità meccanica e 
    dalla capacità di mantenere un \textit{hovering} (volo stazionario) estremamente stabile. 
    ...
    dedicate (piste) o spazi ampi per le manovre di decollo e atterraggio, precludendone l'uso in ambienti confinati.
