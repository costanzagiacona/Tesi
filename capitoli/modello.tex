...
\begin{equation}
    M_{\mathrm{tot}} = M_{\mathrm{th}} + M_{\mathrm{tor}} + M_{\mathrm{aero}} + M_{\mathrm{gyro}} + M_{\mathrm{fin}}
\end{equation}
...
\end{equation}
Inoltre, la rotazione delle eliche genera un momento torcente ($M_{\mathrm{tor}}$) opposto al verso di rotazione, proporzionale al quadrato della velocità angolare ($\tau_i = b \omega_i^2$). Poiché i rotori sono inclinabili, anche questo momento viene proiettato sugli assi del body frame in funzione degli angoli di tilt.
