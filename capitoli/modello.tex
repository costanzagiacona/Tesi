...
\end{itemize}
La trasformazione delle velocità lineari dal sistema solidale a quello inerziale avviene tramite la matrice di rotazione $R_{b \to g}$ (convenzione ZYX):
\begin{equation}
...
\end{equation}
dove $m$ è la massa totale del velivolo, $I_b$ è il tensore d'inerzia (assunto diagonale per simmetria strutturale), $F_{\mathrm{tot}}$ e $M_{\mathrm{tot}}$ sono rispettivamente la somma delle forze e dei momenti esterni agenti sul corpo, espressi nel \textit{body frame}.
...
\subsection{Spinta dei Propulsori (Thrust)}
...
La forza peso, costante nel sistema inerziale, viene ruotata nel sistema solidale:
\begin{equation}
