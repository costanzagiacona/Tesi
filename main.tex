...
\label{ch:modello}
\input{capitoli/modello_aggiornato.tex} % Qui andrebbero le equazioni di moto (Thrust, Gravità)
...
\input{capitoli/controllo_orizzontale.tex} % <--- Assicurati di aver salvato il file con questo nome
