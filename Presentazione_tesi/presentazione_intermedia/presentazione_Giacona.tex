...
\begin{frame}{Motor Mixing Algorithm: Latero-Direzionale}
    ...
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            ...
            \begin{equation}
                \Delta\omega_{des} = \frac{M_x}{2 d_{my}}
            \end{equation}
            \begin{equation}
                \begin{cases}
                    T_{1} = \frac{T_{front}}{2} - \Delta\omega_{des}\\
                    T_{2} = \frac{T_{front}}{2} + \Delta\omega_{des}
                \end{cases}
            \end{equation}
        \end{column}
        \begin{column}{0.48\textwidth}
    ...
    \begin{columns}[c]
        \begin{column}{0.6\textwidth}
            ...
            \begin{itemize}
                ...
                \item Rotore di Coda: \textbf{Spento} (per evitare instabilità su Roll).
            \end{itemize}
...
\begin{frame}{Scenario 1: Decollo con SMC}
    \textbf{Obiettivo:} Transizione stabile dal suolo all'hovering.
    \vspace{0.2cm}
    \begin{center}
